...
public class CompeticaoDAO implements ICompeticaoDAO<Competicao, CompeticaoDTO> {
        ...
        public List<CompeticaoDTO> BuscarTodosOsDTO() throws SQLException {
                ...
                while (result.next()) {
                        Integer id = result.getInt("id");
                        String nome = result.getString("nome");
                        LocalDate data_cadastro = result.getDate("data_cadastro").toLocalDate();
                        LocalDate data_abertura_apostas = result.getDate("data_abertura_apostas").toLocalDate();
                        LocalDate data_fechamento_apostas = result.getDate("data_fechamento_apostas").toLocalDate();
                        ...
                        competicoes.add(new CompeticaoDTO(id, nome, categoriaDTO, data_cadastro, data_abertura_apostas,
                                        data_fechamento_apostas, quantidadeDeApostas, valorEmJogo, status, atletaDTO));
                }
